...
CAPNP_DECLARE_SCHEMA(b430ee621c139985);
CAPNP_DECLARE_SCHEMA(d16a5280224b9d8a);
enum class Type_d16a5280224b9d8a: uint16_t {
  UNKNOWN,
  CUSTOM_BUTTON,
};
CAPNP_DECLARE_ENUM(Type, d16a5280224b9d8a);
...
struct CarStateSP::ButtonEvent {
  ButtonEvent() = delete;

  class Reader;
  class Builder;
  class Pipeline;
  typedef ::capnp::schemas::Type_d16a5280224b9d8a Type;


  struct _capnpPrivate {
    CAPNP_DECLARE_STRUCT_HEADER(b430ee621c139985, 1, 0)
    #if !CAPNP_LITE
    static constexpr ::capnp::_::RawBrandedSchema const* brand() { return &schema->defaultBrand; }
    #endif  // !CAPNP_LITE
  };
...
public:
  ...
  inline  ::capnp::List< ::cereal::CarStateSP::ButtonEvent,  ::capnp::Kind::STRUCT>::Reader getButtonEvents() const;
...
public:
  ...
  inline  ::capnp::List< ::cereal::CarStateSP::ButtonEvent,  ::capnp::Kind::STRUCT>::Builder getButtonEvents();
  inline void setButtonEvents( ::capnp::List< ::cereal::CarStateSP::ButtonEvent,  ::capnp::Kind::STRUCT>::Reader value);
  inline  ::capnp::List< ::cereal::CarStateSP::ButtonEvent,  ::capnp::Kind::STRUCT>::Builder initButtonEvents(unsigned int size);
  inline void adoptButtonEvents(::capnp::Orphan< ::capnp::List< ::cereal::CarStateSP::ButtonEvent,  ::capnp::Kind::STRUCT>>&& value);
  inline ::capnp::Orphan< ::capnp::List< ::cereal::CarStateSP::ButtonEvent,  ::capnp::Kind::STRUCT>> disownButtonEvents();
...
class CarStateSP::ButtonEvent::Reader {
public:
  ...
  inline  ::cereal::CarStateSP::ButtonEvent::Type getType() const;
...
class CarStateSP::ButtonEvent::Builder {
public:
  ...
  inline  ::cereal::CarStateSP::ButtonEvent::Type getType();
  inline void setType( ::cereal::CarStateSP::ButtonEvent::Type value);
...
#if !CAPNP_LITE
class CarStateSP::ButtonEvent::Pipeline {
public:
...
inline bool CarStateSP::Reader::hasButtonEvents() const {
  return !_reader.getPointerField(
      ::capnp::bounded<0>() * ::capnp::POINTERS).isNull();
}
inline bool CarStateSP::Builder::hasButtonEvents() {
  return !_builder.getPointerField(
      ::capnp::bounded<0>() * ::capnp::POINTERS).isNull();
}
inline  ::capnp::List< ::cereal::CarStateSP::ButtonEvent,  ::capnp::Kind::STRUCT>::Reader CarStateSP::Reader::getButtonEvents() const {
  return ::capnp::_::PointerHelpers< ::capnp::List< ::cereal::CarStateSP::ButtonEvent,  ::capnp::Kind::STRUCT>>::get(_reader.getPointerField(
      ::capnp::bounded<0>() * ::capnp::POINTERS));
}
inline  ::capnp::List< ::cereal::CarStateSP::ButtonEvent,  ::capnp::Kind::STRUCT>::Builder CarStateSP::Builder::getButtonEvents() {
  return ::capnp::_::PointerHelpers< ::capnp::List< ::cereal::CarStateSP::ButtonEvent,  ::capnp::Kind::STRUCT>>::get(_builder.getPointerField(
      ::capnp::bounded<0>() * ::capnp::POINTERS));
}
inline void CarStateSP::Builder::setButtonEvents( ::capnp::List< ::cereal::CarStateSP::ButtonEvent,  ::capnp::Kind::STRUCT>::Reader value) {
  ::capnp::_::PointerHelpers< ::capnp::List< ::cereal::CarStateSP::ButtonEvent,  ::capnp::Kind::STRUCT>>::set(_builder.getPointerField(
      ::capnp::bounded<0>() * ::capnp::POINTERS), value);
}
inline  ::capnp::List< ::cereal::CarStateSP::ButtonEvent,  ::capnp::Kind::STRUCT>::Builder CarStateSP::Builder::initButtonEvents(unsigned int size) {
  return ::capnp::_::PointerHelpers< ::capnp::List< ::cereal::CarStateSP::ButtonEvent,  ::capnp::Kind::STRUCT>>::init(_builder.getPointerField(
      ::capnp::bounded<0>() * ::capnp::POINTERS), size);
}
inline void CarStateSP::Builder::adoptButtonEvents(
    ::capnp::Orphan< ::capnp::List< ::cereal::CarStateSP::ButtonEvent,  ::capnp::Kind::STRUCT>>&& value) {
  ::capnp::_::PointerHelpers< ::capnp::List< ::cereal::CarStateSP::ButtonEvent,  ::capnp::Kind::STRUCT>>::adopt(_builder.getPointerField(
      ::capnp::bounded<0>() * ::capnp::POINTERS), kj::mv(value));
}
inline ::capnp::Orphan< ::capnp::List< ::cereal::CarStateSP::ButtonEvent,  ::capnp::Kind::STRUCT>> CarStateSP::Builder::disownButtonEvents() {
  return ::capnp::_::PointerHelpers< ::capnp::List< ::cereal::CarStateSP::ButtonEvent,  ::capnp::Kind::STRUCT>>::disown(_builder.getPointerField(
      ::capnp::bounded<0>() * ::capnp::POINTERS));
}

inline bool CarStateSP::ButtonEvent::Reader::getPressed() const {
  return _reader.getDataField<bool>(
      ::capnp::bounded<0>() * ::capnp::ELEMENTS);
}

inline bool CarStateSP::ButtonEvent::Builder::getPressed() {
  return _builder.getDataField<bool>(
      ::capnp::bounded<0>() * ::capnp::ELEMENTS);
}
inline void CarStateSP::ButtonEvent::Builder::setPressed(bool value) {
  _builder.setDataField<bool>(
      ::capnp::bounded<0>() * ::capnp::ELEMENTS, value);
}

inline  ::cereal::CarStateSP::ButtonEvent::Type CarStateSP::ButtonEvent::Reader::getType() const {
  return _reader.getDataField< ::cereal::CarStateSP::ButtonEvent::Type>(
      ::capnp::bounded<1>() * ::capnp::ELEMENTS);
}

inline  ::cereal::CarStateSP::ButtonEvent::Type CarStateSP::ButtonEvent::Builder::getType() {
  return _builder.getDataField< ::cereal::CarStateSP::ButtonEvent::Type>(
      ::capnp::bounded<1>() * ::capnp::ELEMENTS);
}
inline void CarStateSP::ButtonEvent::Builder::setType( ::cereal::CarStateSP::ButtonEvent::Type value) {
  _builder.setDataField< ::cereal::CarStateSP::ButtonEvent::Type>(
      ::capnp::bounded<1>() * ::capnp::ELEMENTS, value);
}

...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"DarkMode", {PERSISTENT | BACKUP, BOOL, "0"}},
    {"DisableCarSteerAlerts", {PERSISTENT | BACKUP, BOOL, "0"}},
    {"DisableScreenTimer", {PERSISTENT | BACKUP, BOOL, "0"}},
    {"EnableCurvatureController", {PERSISTENT | BACKUP, BOOL, "0"}},
    {"EnableCurvatureD", {PERSISTENT | BACKUP, BOOL, "0"}},
    ...
    {"EnableSmoothSteer", {PERSISTENT | BACKUP, BOOL, "0"}},
    ...
    {"ShowAccelBar", {PERSISTENT | BACKUP, BOOL, "0"}},
    {"ShowDynamicSteeringLearnerGraph", {PERSISTENT | BACKUP, BOOL, "0"}},

...
class ModelsLayout(Widget):
  ...
  def _get_folders(self, favorites):
    ...
    folders_list = [TreeFolder("", [TreeNode("Default", {'display_name': get_default_model_label(ui_state.default_model_is_big),
                                                         'short_name': "Default"})])]
  ...
  def _update_state(self):
    ...
    default_label = get_default_model_label(ui_state.default_model_is_big)

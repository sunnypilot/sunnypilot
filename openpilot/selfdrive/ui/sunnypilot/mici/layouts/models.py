...
class CurrentModelInfo(Widget):
  def __init__(self):
    ...
    default_text = get_default_model_label(ui_state.default_model_is_big).lower()
...
class ModelsLayoutMici(NavScroller):
  ...
  def _show_folders(self):
    ...
    folder_buttons = []
    default_btn = BigButton(get_default_model_label(ui_state.default_model_is_big).lower())
  ...
  def _update_state(self):
    ...
    model_text = manager.activeBundle.displayName.lower() if manager.activeBundle.ref else get_default_model_label(ui_state.default_model_is_big).lower()

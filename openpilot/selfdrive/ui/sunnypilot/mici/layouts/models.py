...
class CurrentModelInfo(Widget):
  def __init__(self):
    ...
    default_text = f"{get_default_model_name(ui_state.default_model_is_big)} (Default)".lower()
...
class ModelsLayoutMici(NavScroller):
  ...
  def _show_folders(self):
    ...
    folder_buttons = []
    default_btn = BigButton(f"{get_default_model_name(ui_state.default_model_is_big)} (Default)".lower())
  ...
  def _update_state(self):
    ...
    default_model_text = f"{get_default_model_name(ui_state.default_model_is_big)} (Default)".lower()

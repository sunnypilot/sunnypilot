...
from openpilot.sunnypilot.models.default_model import get_default_model_label
...
class CurrentModelInfo(Widget):
  def __init__(self):
    ...
    default_text = get_default_model_label(ui_state.usbgpu and ui_state.usbgpu_compiled).lower()
...
class ModelsLayoutMici(NavScroller):
  ...
  def _show_folders(self):
    ...
    folder_buttons = []
    default_btn = BigButton(get_default_model_label(ui_state.usbgpu and ui_state.usbgpu_compiled).lower())
  ...
  def _update_state(self):
    ...
    default_label = get_default_model_label(ui_state.usbgpu and ui_state.usbgpu_compiled)
    model_text = manager.activeBundle.displayName.lower() if manager.activeBundle.ref else default_label.lower()

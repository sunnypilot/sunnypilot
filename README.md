...
By default, sunnypilot uploads the driving data to comma servers and to OpenStreetMaps. You can also access your data through [comma connect](https://connect.comma.ai/).

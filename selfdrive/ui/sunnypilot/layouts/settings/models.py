...
class ModelsLayout(Widget):
  ...
  def _get_folders(self, favorites):
    ...
    folders_list = [TreeFolder("", [TreeNode("Default", {'display_name': DEFAULT_MODEL, 'short_name': "Default"})])]
  ...
  def _update_state(self):
    ...
    active_name = self.model_manager.activeBundle.internalName if self.model_manager and self.model_manager.activeBundle.ref else DEFAULT_MODEL

...
void NvgWindow::drawHud(QPainter &p) {
  ...
  if (is_metric || (showSpeedLimit && speedLimitStyle == 1) || (has_eu_speed_limit && !(speedLimitStyle == 0))) rect_width = 200;
  if ((showSpeedLimit && speedLimitStyle == 0 && speedLimitStrSlc.size() >= 3) || ((has_us_speed_limit && !(speedLimitStyle == 1)) && speedLimitStr.size() >= 3)) rect_width = 223;

  int rect_height = 204;
  if ((showSpeedLimit && speedLimitStyle == 0) || (has_us_speed_limit && !(speedLimitStyle == 1))) rect_height = 432;
  else if ((showSpeedLimit && speedLimitStyle == 1) || (has_eu_speed_limit && !(speedLimitStyle == 0))) rect_height = 392;

  int top_radius = 32;
  int bottom_radius = ((showSpeedLimit && speedLimitStyle == 1) || (has_eu_speed_limit && !(speedLimitStyle == 0))) ? 100 : 32;
  ...
  if ((showSpeedLimit && speedLimitStyle == 0) || (has_us_speed_limit && !(speedLimitStyle == 1))) {
  ...
  if ((showSpeedLimit && speedLimitStyle == 1) || (has_eu_speed_limit && !(speedLimitStyle == 0))) {

...
AutoLaneChangeTimer::AutoLaneChangeTimer() : AbstractControl("Auto Lane Change Timer", "Set a timer to delay the auto lane change operation when the blinker is used. No nudge on the steering wheel is required to auto lane change if a timer is set. Please use caution when using this feature. Only use the blinker when traffic and road conditions permit.", "../assets/offroad/icon_shell.png") {

...
VisualsPanel::VisualsPanel(QWidget *parent) : ListWidget(parent) {
  ...
  chevron_info_settings = new ButtonParamControl(
    "ChevronInfo", "Display Metrics Below Chevron", "Display useful metrics below the chevron that tracks the lead car (only applicable to cars with openpilot longitudinal control).",
    "../assets/offroad/icon_blank.png",

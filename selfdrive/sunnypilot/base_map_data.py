...
from openpilot.selfdrive.sunnypilot import _debug
...
class BaseMapData(ABC):
  ...
  def publish(self):
    ...
    _debug(f"SRC: {self.__class__.__name__} | SLC: {speed_limit} | NSL: {next_speed_limit} | NSLD: {next_speed_limit_distance} | CRN: {current_road_name}")

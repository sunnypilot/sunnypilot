...
class Controls:
  ...
  def state_control(self, CS):
    ...
    CC.longActive = self.active and CS.cruiseState.enabled and not (CS.brakePressed and (not self.CS_prev.brakePressed or not CS.standstill)) and not self.events.any(ET.OVERRIDE_LONGITUDINAL) and not self.events.any(ET.NO_ENTRY)

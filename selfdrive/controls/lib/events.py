...
class StartupAlert(Alert):
  def __init__(self, alert_text_1: str, alert_text_2: str = "To use MADS, toggle the ACC MAIN button", alert_status=AlertStatus.normal):
    super().__init__(alert_text_1, alert_text_2,
...
def no_gps_alert(CP: car.CarParams, sm: messaging.SubMaster, metric: bool, soft_disable_time: int) -> Alert:
  ...
  return Alert(
    ...
    AlertStatus.normal, AlertSize.mid,
    Priority.LOWER, VisualAlert.none, AudibleAlert.none, .2, creation_delay=300000000000.)

...
def standstill_alert(CP, sm, metric):
  ...
  if elapsed_time_min == 0:
    return Alert(
      "Paused (Elapsed Time: %02d Seconds)" % (elapsed_time_sec),
      "",
      AlertStatus.normal, AlertSize.small,
      Priority.LOW, VisualAlert.none, AudibleAlert.none, .0, .1, .1, alert_rate=0.5)
  else:
    return Alert(
      "Paused (Elapsed Time: %d Minutes %02d Seconds)" % (elapsed_time_min, elapsed_time_sec),
      "",
      AlertStatus.normal, AlertSize.small,
      Priority.LOW, VisualAlert.none, AudibleAlert.none, .0, .1, .1, alert_rate=0.5)
...
EVENTS: Dict[int, Dict[str, Union[Alert, Callable[[Any, messaging.SubMaster, bool], Alert]]]] = {
  ...
  EventName.startup: {
    ET.PERMANENT: Alert(
      ...
      "Toggle autosteer with the Curise MAIN button.",
      AlertStatus.normal, AlertSize.mid,
  ...
  EventName.preLaneChangeRight: {
    ET.WARNING: Alert(
      "teer Right to Start Lane Change",
      "Monitor Other Vehicles",
      AlertStatus.normal, AlertSize.mid,
      Priority.LOW, VisualAlert.none, AudibleAlert.none, .0, .1, .1, alert_rate=0.75),
  },
  ...
  EventName.laneChangeManual: {
    ET.WARNING: Alert(
      "Lane Change at Low Speed Detected",
  ...
  EventName.modeChangeMaponly: {
    ET.WARNING: Alert(
      "Map-based Deceleration Mode ONLY",
      "",
      AlertStatus.normal, AlertSize.small,
  ...
  EventName.isgActive: {
    ET.WARNING: Alert(
      "Steering Suspended, ISG Enabled",
      "",
      AlertStatus.normal, AlertSize.small,
      Priority.LOW, VisualAlert.none, AudibleAlert.none, .0, .1, .1, alert_rate=0.75),
  },
  ...
  EventName.calibrationInvalid: {
    ET.PERMANENT: NormalPermanentAlert("Calibration Invalid", "Remount Device & Recalibrate"),

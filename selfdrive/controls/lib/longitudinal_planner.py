...
class LongitudinalPlanner:
  def __init__(self, CP, init_v=0.0, init_a=0.0, dt=DT_MDL):
    ...
    self.fast_take_off_vroom= False
  ...
  def update(self, sm):
    ...
    self.fast_take_off_vroom = self.fast_take_off and v_ego <= 7.5
    self.mpc.update(sm['radarState'], v_cruise, x, v, a, j, personality=sm['controlsStateSP'].personality, dynamic_personality=sm['controlsStateSP'].dynamicPersonality, fast_take_off=self.fast_take_off_vroom)

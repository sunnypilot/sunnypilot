  ...
  def update(self, CC, CS, now_nanos):
    ...
    if self.CP.carFingerprint in PREGLOBAL_CARS:
      ...
      if self.frame % 10 == 0:
        ...
        can_sends.append(subarucan.create_es_lkas_state(self.packer, self.frame // 10, CS.es_lkas_state_msg, CC.latActive, CS.out.madsEnabled, hud_control.visualAlert,

...
def create_lfahda_mfc(packer, long_active, lat_active, disengage_from_brakes, below_lane_change_speed, disengage_blinking_icon, slc_active, speed_limit, speed_limit_changed, switching_to_hda, hda_set_speed=0):
  values = {

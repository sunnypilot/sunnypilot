import crcmod
from openpilot.selfdrive.car.hyundai.values import CAR, CHECKSUM, CAMERA_SCC_CAR, HyundaiFlags
...
def create_clu11(packer, frame, clu11, button, CP, CAN):
  ...
  bus = 2 if CP.carFingerprint in CAMERA_SCC_CAR else CAN.ECAN if CP.flags & HyundaiFlags.CAN_CANFD_HYBRID else 0

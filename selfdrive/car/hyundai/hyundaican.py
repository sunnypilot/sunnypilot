...
def create_lkas11(packer, frame, car_fingerprint, apply_steer, steer_req,
                  lkas11, sys_warning, sys_state, enabled, lkas_active, disengage_from_brakes, below_lane_change_speed, disengage_blinking_icon,
  ...
  if car_fingerprint in [CAR.SONATA, CAR.PALISADE, CAR.KIA_NIRO_EV, CAR.KIA_NIRO_HEV_2021, CAR.SANTA_FE,
    ...
    values["CF_Lkas_FcwOpt_USM"] = 2 if lkas_active else 2 if disengage_blinking_icon else 1 if (disengage_from_brakes or below_lane_change_speed) else 1

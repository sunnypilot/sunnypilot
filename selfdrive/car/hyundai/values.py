...
class CAR(StrEnum):
  ...
  HYUNDAI_PALISADE_2023 = "HYUNDAI_PALISADE_2023"
...
CHECKSUM = {
  "crc8": [CAR.SANTA_FE, CAR.SONATA, CAR.PALISADE, CAR.KIA_SELTOS, CAR.ELANTRA_2021, CAR.ELANTRA_HEV_2021,
           ...
           CAR.KIA_SELTOS_2023_NON_SCC, CAR.BAYON_1ST_GEN_NON_SCC, CAR.HYUNDAI_PALISADE_2023],
...
CANFD_CAR = {CAR.KIA_EV6, CAR.IONIQ_5, CAR.IONIQ_6, CAR.TUCSON_4TH_GEN, CAR.SANTA_CRUZ_1ST_GEN, CAR.KIA_SPORTAGE_5TH_GEN, CAR.GENESIS_GV70_1ST_GEN,
             ...
             CAR.STARIA_4TH_GEN, CAR.HYUNDAI_PALISADE_2023}
CAN_CANFD_HYBRID_CAR = {CAR.HYUNDAI_PALISADE_2023, }

# The radar does SCC on these cars when HDA I, rather than the camera
CANFD_RADAR_SCC_CAR = {CAR.GENESIS_GV70_1ST_GEN, CAR.KIA_SORENTO_4TH_GEN, CAR.GENESIS_GV80, CAR.KIA_CARNIVAL_4TH_GEN, CAR.KIA_SORENTO_HEV_4TH_GEN, CAR.HYUNDAI_PALISADE_2023}
...
DBC = {
  ...
  CAR.HYUNDAI_PALISADE_2023: dbc_dict('hyundai_palisade_2023_generated', None),
}

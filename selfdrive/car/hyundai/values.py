...
class CAR:
  ...
  KIA_SELTOS_2024_NON_SCC = "KIA SELTOS 2024 NON-SCC"
...
CAR_INFO: Dict[str, Optional[Union[HyundaiCarInfo, List[HyundaiCarInfo]]]] = {
  ...
  CAR.KIA_SELTOS_2024_NON_SCC: HyundaiCarInfo("Kia Seltos Non-SCC 2024", "No Smart Cruise Control (SCC)", car_parts=CarParts.common([CarHarness.hyundai_l])),
...
CHECKSUM = {
  "crc8": [CAR.SANTA_FE, CAR.SONATA, CAR.PALISADE, CAR.KIA_SELTOS, CAR.ELANTRA_2021, CAR.ELANTRA_HEV_2021,
           ...
           CAR.ELANTRA_2022_NON_SCC, CAR.GENESIS_G70_2021_NON_SCC, CAR.KIA_SELTOS_2024_NON_SCC],
...
DBC = {
  ...
  CAR.KIA_SELTOS_2024_NON_SCC: dbc_dict('hyundai_kia_generic', None),

  ...
  def _get_params(ret, candidate, fingerprint, car_fw, experimental_long, docs):
    ...
    if candidate in CANFD_CAR:
      ...
      if hda2:
        ...
        if 0x160 not in fingerprint[CAN.ECAN]:
          ret.flags |= HyundaiFlags.CANFD_ADRV.value
    else:
    ...
    if candidate in CANFD_CAR:
      ...
      if ret.flags & HyundaiFlags.CANFD_ADRV:
        ret.safetyConfigs[-1].safetyParam |= Panda.FLAG_HYUNDAI_CANFD_ADRV
    else:

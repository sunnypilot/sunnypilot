...
from openpilot.selfdrive.car.hyundai.values import HyundaiFlags, HyundaiFlagsSP, CAR, DBC, CAN_GEARS, CAMERA_SCC_CAR, \
                                                   ...
                                                   Buttons, CarControllerParams, CAN_CANFD_HYBRID_CAR
...
class CarState(CarStateBase):
  ...
  def update(self, cp, cp_cam):
    ...
    if not self.CP.openpilotLongitudinalControl and self.CP.carFingerprint not in NON_SCC_NO_FCA_CAR and not (self.CP.flags & HyundaiFlags.CAN_CANFD_HYBRID):
  ...
  def get_can_parser(self, CP):
    ...
    if not CP.openpilotLongitudinalControl:
      ...
      elif CP.carFingerprint not in (CAMERA_SCC_CAR | (NON_SCC_CAR - NON_SCC_RADAR_FCA_CAR)):

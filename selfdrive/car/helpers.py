...
def convert_carControlSP(struct: capnp.lib.capnp._DynamicStructReader) -> structs.CarControlSP:
  ...
  struct_dataclass.intelligentCruiseButtonManagement = structs.IntelligentCruiseButtonManagement(**remove_deprecated(struct_dict.get('intelligentCruiseButtonManagement', {})))

...
class CarInterface(CarInterfaceBase):
  ...
  def _update(self, c):
    ...
    ret = self.get_sp_common_state(ret, gap_button=(self.CS.gap_dist_button == 3))
    ...
    events = self.create_sp_events(ret, events, enable_buttons=(ButtonType.setCruise, ButtonType.resumeCruise))

...
from openpilot.selfdrive.car.ford.values import CANFD_CAR,CAN_Navigator,CarControllerParams, DBC, BUTTON_STATES
...
class CarState(CarStateBase):
  ...
  def update(self, cp, cp_cam):
    ...
    if self.CP.carFingerprint in CAN_Navigator:
  ...
  def get_can_parser(CP):
    ...
    if CP.carFingerprint in CAN_Navigator:
      messages += [
        ("ParkAid_Data", 50),
      ]
    else:

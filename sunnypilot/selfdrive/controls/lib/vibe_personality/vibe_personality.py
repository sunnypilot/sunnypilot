...
MIN_ACCEL_PROFILES = {
  ...
  LongPersonality.aggressive: [-.010000, -.01000, -.03000, -.07175, -1.6, -1.6],  # sport-like
}
...
FOLLOW_DISTANCE_PROFILES = {
  LongPersonality.relaxed: {
    ...
    'y_dist': [1.45, 1.45, 1.80, 1.80, 1.90, 1.90]
  },
  LongPersonality.standard: {
    'x_vel':  [0.,   4.9,   5.,   14.,  14.5, 19.7, 22.2, 40.],
    'y_dist': [1.10, 1.31, 1.31, 1.31, 1.37, 1.37, 1.45, 1.45]
  },
  LongPersonality.aggressive: {
    'x_vel':  [0.,   4.9,    5.,   14.,  14.5, 19.7, 22.2, 40.],
    'y_dist': [1.00, 1.30,  1.30, 1.30, 1.35, 1.35, 1.45, 1.45]
  }
}

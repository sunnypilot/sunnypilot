...
# Profiles
MAX_ACCEL_PROFILES = {
  "eco":                [2.00, 2.00, 1.99, 1.73, 0.83, .572, .455, .365, .32, .10],
  "normal":             [2.00, 2.00, 2.00, 1.84, 1.00, .64,  .55, .42, .37, .15],
  "sport":              [2.00, 2.00, 2.00, 1.95, 1.25, .78,  .67, .50, .43, .20],
}
MAX_ACCEL_BREAKPOINTS = [0.,   2.,   7.,   9.,   11.,  16.,  20., 25., 30., 55.]

MIN_ACCEL_PROFILES = {
  "eco":                [-.071145,  -.0713, -.0716,  -.0716, -1.4, -1.4],
  "normal":             [-.071145,  -.0714, -.0717,  -.0717, -1.5, -1.5],
  "sport":              [-.071145,  -.0715, -.0718,  -.0718, -1.6, -1.6],

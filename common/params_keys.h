...
inline static std::unordered_map<std::string, uint32_t> keys = {
    ...
    {"AutoLaneChangeSlowLead", PERSISTENT | BACKUP},
    ...
    {"ShowDABInspector", PERSISTENT | BACKUP},
    {"DynamicAcceleration", PERSISTENT | BACKUP},
    {"DABPhantomGate", PERSISTENT | BACKUP},
    {"DABLeadGate", PERSISTENT | BACKUP},
    {"DABTTSGate", PERSISTENT | BACKUP},
    {"DABCurvGate", PERSISTENT | BACKUP},
    {"DABSlowLeadGate", PERSISTENT | BACKUP},

...
std::unordered_map<std::string, uint32_t> keys = {
    ...
    {"ModelManager_DownloadProgress", CLEAR_ON_MANAGER_START | CLEAR_ON_OFFROAD_TRANSITION | CLEAR_ON_ONROAD_TRANSITION},
    {"ModelManager_DownloadRequested", CLEAR_ON_MANAGER_START },
};

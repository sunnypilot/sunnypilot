...
std::unordered_map<std::string, uint32_t> keys = {
    ...
    {"CustomDrivingModel", PERSISTENT | BACKUP},
    ...
    {"DrivingModelGeneration", PERSISTENT | BACKUP},
    {"DrivingModelMetadataText", PERSISTENT | BACKUP},
    {"DrivingModelName", PERSISTENT | BACKUP},
    {"DrivingModelText", PERSISTENT | BACKUP},
    {"DrivingModelUrl", PERSISTENT | BACKUP},
